...
public class arcanaInfoPreferenceController extends AbstractPreferenceController {
    ...
    private static final String PROP_ARCANA_VERSION = "ro.banana.version";
    private static final String PROP_ARCANA_VERSION_CODE = "ro.modversion";
    private static final String PROP_ARCANA_RELEASETYPE = "ro.banana.releasetype";
    private static final String PROP_ARCANA_MAINTAINER = "ro.banana.edition";
    private static final String PROP_ARCANA_DEVICE = "ro.banana.device";
