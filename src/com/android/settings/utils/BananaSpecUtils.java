...
public class BananaSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String BANANA_CPU_MODEL_PROPERTY = "ro.banana.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelBanana = SystemProperties.get(BANANA_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelBanana.isEmpty()) {
            return cpuModelBanana;
