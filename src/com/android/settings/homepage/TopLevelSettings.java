...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        boolean customUIToggleValue = Settings.System.getIntForUser(getContext().getContentResolver(),
                Settings.System.CUSTOM_UI_TOGGLE, 0, UserHandle.USER_CURRENT) != 0;
        if (customUIToggleValue) {
            onSetPrefCard();
        }
        boolean aboutStyleToggleValue = Settings.System.getIntForUser(getContext().getContentResolver(),
                Settings.System.ABOUT_PHONE_HEADER, 0, UserHandle.USER_CURRENT) != 0;
        if (aboutStyleToggleValue) {
            onSetAboutStyle();
        }
    }
